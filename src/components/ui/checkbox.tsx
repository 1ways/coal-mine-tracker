    ...
    return (
        ...
        >
            <CheckboxPrimitive.Indicator
                ...
                className="grid place-content-center text-current transition-all [&>svg]:size-3.5"
            >
                <CheckIcon
                />
            </CheckboxPrimitive.Indicator>
